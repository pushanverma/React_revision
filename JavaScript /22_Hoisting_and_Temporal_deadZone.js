...
// op - output of the above program is "undefined" , because during hoisting all the variables are pulled up and in memory phase , all the variables are initialized with value "undefied".
