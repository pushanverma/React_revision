...
// the above statement cannot take place because we cannot use a variable before it is initialized, it is like using something which has not produced uptill now
