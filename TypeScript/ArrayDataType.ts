...
var students: string[] = ["pushan", "dheeraj", "dakshesh", "pradhap"];
var marks: number[] = [12, 13, 14, 15, 16, 17];
var flag: boolean[] = [true, false, true, false, false];
var matrix: number[][] = [
  [1, 2, 3],
  [4, 5, 6],
  [7, 8, 9],
...
var student_name: Array<String> = ["pushan", "dheeraj", "dakshesh", "pradhap"];
var students_marks: Array<Number> = [12, 13, 14, 15, 16, 17];
var student_flag: Array<Boolean> = [true, false, true, false, true, true];
...
var data :ReadonlyArray<String> =["pushan","chandresh","aditi", "chetna"];
